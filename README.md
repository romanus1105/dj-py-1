...
В данной заготовке с Django проектом, в котором уже было добавлено 1 приложение – `app`, реализовано 3 view функции и настроены для них правильные унифицированный указатель ресурса:
